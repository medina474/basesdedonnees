...
\copy series to 'data/cinema/041-series.csv' (format csv, header, encoding 'utf8');
\copy (select societe_id, societe, uei from societes order by societe_id) to 'data/cinema/011-societes.csv' (format csv, header, encoding 'utf8');
