...
insert into depot (id,depot,code,capacite,adresse,code_postal,ville,actif,localisation) values
  (0,'Livraison à domicile','00',100, '', '', '',true,null),
  (1,'Jardins de Cocagne','11',100,'Prairie Claudel','88150','Thaon-les-Vosges',true,'SRID=4326;POINT(6.427672 48.2531016)'),
  (2,'Asso Étudiant Universitaire','02',20,'9 rue de la Louvière','88000','Épinal',true,'SRID=4326;POINT(6.4531588 48.1723212)'),
  (3,'Conseil Départemental des Vosges','03',20,'8 rue de la Préfecture','88000','Épinal',true,'SRID=4326;POINT(6.4445154 48.1721724)'),
  (4,'Asso Rhyzome','04',20,'15 rue des Jardiniers','88000','Épinal',true,'SRID=4326;POINT(6.452224 48.1706099)'),
  (6,'Pharmacie Saint Nabord','06',20,'24 rue du Gal de Gaulle','88200','St Nabord',true,'SRID=4326;POINT(6.5807814 48.0510352)'),
  (8,'Denninger','08',25,'36 bis rue de la Plaine','88190','Golbey',true,'SRID=4326;POINT(6.4426982 48.1929337)'),
  (9,'3e Rive (Café Associatif)','09',20,'15 rue du Maréchal Lyautey','88000','Épinal',true,'SRID=4326;POINT(6.4457306 48.177777)'),
  (10,'Crédit Agricole','10',20,'Allée des Érables','88000','Épinal',false,'SRID=4326;POINT(6.454908 48.203990)'),
  (12,'Centre Léo Lagrange','12',60,'6 av. Salvador Allende','88000','Épinal',true,'SRID=4326;POINT(6.4599403 48.1938105)'),
  (13,'Boulassel Docelles','13',20,'1 rue Moncey','88460','Docelles',true,'SRID=4326;POINT(6.6162166 48.1460719)'),
  (14,'Ligue de l’enseignement','24',40,'15 rue Général de Reffye','88000','Épinal',true,'SRID=4326;POINT(6.4323215 48.1819469)'),
  (15,'Garage Renault- Station Service','15',20,'664 rue de la Gare','88550', 'Pouxeux',true,'SRID=4326;POINT(6.5760129 48.1051197)'),
  (16,'Adinolfi','16',40,'7 allée des Primevères','88390','Les Forges',false,'SRID=4326;POINT(6.397633 48.171791)'),
  (17,'Lecompte François','17',40,'24 route du Noirpré','88530','Le Tholy',true,'SRID=4326;POINT(6.7477787 48.0812967)'),
  (18,'Papeterie Norske Skog','18',20,'ZI Route Charles Pellerin','88190','Golbey',true,'SRID=4326;POINT(6.423976 48.208795)'),
  (19,'Botanic','19',20,'9 av. des Terres St Jean','88000','Épinal',true,'SRID=4326;POINT(6.4692286 48.1891998)'),
  (20,'Pro & Cie','20',40,'7 rue de la République','88400','Gérardmer',true,'SRID=4326;POINT(6.877433 48.074172)'),
  (21,'Mme Pierot Charmes','21',40,'15 rue Ste Barbe','88130','Charmes',false,'SRID=4326;POINT(6.2951122 48.3777043)'),
  (25,'DVIS Epinal','25',20,'1 Rue de la Préfecture','88000','Épinal',true,'SRID=4326;POINT(6.44875 48.172438)'),
  (26,'Peridon','26',20,'7 rue du Savron','88220','Raon-aux-Bois',true,'SRID=4326;POINT(6.5036466 48.0504027)'),
  (31,'Chambre d’Agriculture','31',20,'17 rue André Vitu','88000','Épinal',true,'SRID=4326;POINT(6.465403 48.1775685)'),
  (34,'Biocoop','34',20,'7 rue du Boudiou','88000','Épinal',true,'SRID=4326;POINT(6.447245 48.174228)'),
  (36,'Moustaches Bikes','36',20,'5 rue du Ruisseau','88150','Thaon-les-Vosges',true,'SRID=4326;POINT(6.4005773 48.2576491)'),
  (38,'Vosgelis Remiremont','38',20,'4 place de l’Abbaye','88200','Remiremont',true,'SRID=4326;POINT(6.592068 48.015964)'),
  (42,'Église Saint Antoine','42',72,'12 rue Armand Colle','88000','Épinal',true,'SRID=4326;POINT(6.4489619 48.1604568)'),
  (46,'Maison de l’Environnement','46',60,'12 rue  Raymond Poincaré','88000','Épinal',true,'SRID=4326;POINT(6.449693 48.175374)'),
  (48,'Vosgelis','48',20,'8 quai Barbier','88000','Épinal',false,'SRID=4326;POINT(6.445190 48.171198)'),
  (50,'Association GACI','50',20,'26 rue de la Joncherie','88200','Remiremont',true,'SRID=4326;POINT(6.5934293 48.0189339)'),
  (55,'Brico Marché','55',35,'2 rue de Fraisne','88600','Bruyères',true,'SRID=4326;POINT(6.7196903 48.2050495)'),
  (57,'Office du tourisme','57',20,'6 place C. Poncelet','88200','Remiremont',false,'SRID=4326;POINT(6.5917178 48.0159918)'),
  (60,'Point Vert Mafra','60',20,'5 rue des Résistants Zac Barbazan','88600','Bruyères',true,'SRID=4326;POINT(6.7208371 48.2032056)'),
  (61,'La Quarterelle','61',20,'3 rue Carterelle','88200','Épinal',true,'SRID=4326;POINT(6.7208371 48.2032056)'),
  (62,'Léo Lagrange','62',20,'Chemin du Tambour Major','88000','Épinal',true,'SRID=4326;POINT(6.7208371 48.2032056)'),
  (65,'Bouvier Emmanuel','65',20,'557 rue du Chêne','88220','Hadol',true,'SRID=4326;POINT(6.484004 48.108499)'),
  (75,'APF - Local extérieur – ESAT','75',20,'rue de la papeterie','88000','Dinozé',true,'SRID=4326;POINT(6.4738942 48.1383687)'),
  (77,'La tête à Toto','77',20,'26 quai des Bons Enfants','88000','Épinal',false,'SRID=4326;POINT(6.4409549 48.1748623)'),
  (78,'UIMM','78',20,'Label Initiative','88150','Thaon les Vosges',true,'SRID=4326;POINT (6.4409549 48.1748623)'),
  (80,'Résidence du Monsey','80',20,'Ruelle de Monsey', '88450', 'Vincey',true,'SRID=4326;POINT(6.330850 48.337907)'),
  (81,'Complexe Sportif','81',60,'Bld Georges Clemenceau','88130','Charmes',true,'SRID=4326;POINT(6.298452 48.375298)'),
  (83,'Fives','83',30,'2 rue des Amériques','88190','Golbey',true,'SRID=4326;POINT(6.428831 48.200150)'),
  (84,'Nomexy Secours Catholique','01',20,'1 place de Verdun', '88440', 'Nomexy',true,'SRID=4326;POINT(6.386527 48.305704)'),
  (85,'Réserve','99',20,'','','',true,null);
